        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Employees_WorkTitles_WorkTitleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicantEducations_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicantHobbies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicantHobbies_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicantLanguages_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicantWorkExperiences_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicantWorkExperiences_WorkTitles_WorkTitleId",
                        column: x => x.WorkTitleId,
                        principalTable: "WorkTitles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InterviewerUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b042c90b-7489-4a51-9a55-ea2fc1c8bd07", "ee80964c-d7f8-4481-8799-9f220b696170", "Admin", "ADMIN" },
                    { "5c4e3a62-b325-4826-8255-2604986e6441", "1ba9d532-8171-4a46-bfd5-28c68162cc2e", "User", "USER" }
                });

            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "IsActive", "IsDeleted", "Name" },
                values: new object[] { 1, true, false, "Türkiye" });

            migrationBuilder.InsertData(
                table: "WorkTitles",
                columns: new[] { "Id", "IsActive", "IsDeleted", "Name" },
                values: new object[] { 1, true, false, "Backend Developer" });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "CountryId", "IsActive", "IsDeleted", "Name" },
                values: new object[] { 1, 1, true, false, "İzmir" });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantEducations_ApplicationId",
                table: "ApplicantEducations",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantHobbies_ApplicationId",
                table: "ApplicantHobbies",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantLanguages_ApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicantWorkExperiences_ApplicationId",
                table: "ApplicantWorkExperiences",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantWorkExperiences_WorkTitleId",
                table: "ApplicantWorkExperiences",
                column: "WorkTitleId");
